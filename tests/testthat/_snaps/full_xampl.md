...
---
    ...
    @InCollection{incollection-minimal}
      author:
        given = c("Daniel", "D.") | family = "Lincoll"
    ...
    @InCollection{incollection-full}
      ...
      title = "Semigroups of Recurrences"
      editor:
        given = c("David", "J.") | family = "Lipcoll"
        given = c("D.", "H.") | family = "Lawrie"
        given = c("A.", "H.") | family = "Sameh"
      booktitle = "High Speed Computer and Algorithm Organization"
      number = "23"
    ...
    @Misc{misc-full}
      author:
        given = "Joe-Bob" | family = "Missilany"
    ...
    @InProceedings{inproceedings-minimal}
      author:
        given = c("Alfred", "V.") | family = "Oaho"
        given = c("Jeffrey", "D.") | family = "Ullman"
        given = "Mihalis" | family = "Yannakakis"
    ...
    @PhdThesis{phdthesis-minimal}
      author:
        given = c("F.", "Phidias") | family = "Phony-Baloney"
    ...
    @Unpublished{unpublished-minimal}
      author:
        given = "Ulrich" | family = "Ünderwood"
        given = "Ned" | family = "Ñet"
        given = "Paul" | family = "\\=Pot"
